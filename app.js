...
const CHAPTERS = {
  houki: [{
    id: "h_1_1",
    textbook: "# 1　用語の定義\n\n## 1-1　まず「特殊建築物」を丸ごと覚える\n\n**特殊建築物（法2条二号）**＝\n学校、体育館、病院、劇場、観覧場、集会場、展示場、百貨店、市場、ダンスホール、遊技場、公衆浴場、旅館、共同住宅、寄宿舎、下宿、工場、倉庫、自動車車庫、危険物の貯蔵場、と畜場、火葬場、汚物処理場、その他これらに類する用途。\n\n**試験上の注意：**「不特定多数が利用する建物」だけではない。工場・倉庫・危険物貯蔵場なども特殊建築物に含まれる。逆に、一般的な戸建住宅・事務所は法2条二号の列挙には含まれない。\n\n| **分類**   | **代表例**                               | **覚え方**       |\n|------------|------------------------------------------|------------------|\n| 集会・観覧 | 劇場、観覧場、集会場、展示場             | 人が集まる       |\n| 教育・運動 | 学校、体育館                             | 学校・スポーツ   |\n| 宿泊・居住 | 病院、旅館、共同住宅、寄宿舎、下宿       | 人が滞在         |\n| 物販・娯楽 | 百貨店、市場、ダンスホール、遊技場       | 人＋商品・娯楽   |\n| 公衆衛生   | 公衆浴場                                 | 不特定多数       |\n| 産業・保管 | 工場、倉庫                               | 火災・避難リスク |\n| 危険・処理 | 危険物貯蔵場、と畜場、火葬場、汚物処理場 | 特殊な危険・処理 |\n\n**【暗記BOX】特殊建築物のひっかけ**\n\n> **●**\n> 「特殊建築物」＝法2条二号の定義。「別表第一の(い)欄」と同じ意味ではない。\n>\n> **●**\n> 建築基準法の各規制では、法2条二号だけでなく、法27条・令112条・令128条の4などで用途・規模を改めて確認する。\n>\n> **●** 「共同住宅」は特殊建築物。これは頻出。\n>\n> **●** 「事務所」は法2条二号の特殊建築物ではない。\n\n## 1-2　建築物・建築設備・居室・主要構造部\n\n| **用語**       | **条文**    | **暗記ポイント**                                                             |\n|----------------|-------------|------------------------------------------------------------------------------|\n| 建築物         | 法2条一号   | 屋根＋柱/壁を有するもの等。建築設備を含む。                                  |\n| 特殊建築物     | 法2条二号   | 上記の一覧を覚える。                                                         |\n| 建築設備       | 法2条三号   | 電気・ガス・給排水・換気・暖冷房・消火・排煙・汚物処理＋煙突・昇降機・避雷針 |\n| 居室           | 法2条四号   | 居住・執務・作業・集会・娯楽等の目的で継続的に使用する室                     |\n| 主要構造部     | 法2条五号   | 壁・柱・床・はり・屋根・階段。ただし一定の除外あり                           |\n| 建築           | 法2条十三号 | 新築・増築・改築・移転                                                       |\n| 大規模の修繕   | 法2条十四号 | 主要構造部の一種以上について過半を修繕                                       |\n| 大規模の模様替 | 法2条十五号 | 主要構造部の一種以上について過半を模様替                                     |\n\n**★\n主要構造部の注意**　「構造上重要な部分」と完全に同義ではない。法2条五号の定義をそのまま覚える。最下階の床、屋外階段、ひさし等、除外されるものがある。\n\n## 1-3　防火関係用語\n\n| **用語**               | **条文等**                | **暗記ポイント**                         |\n|------------------------|---------------------------|------------------------------------------|\n| 主要構造部             | 法2条五号                 | 壁・柱・床・はり・屋根・階段             |\n| 延焼のおそれのある部分 | 法2条六号                 | 隣地境界線・道路中心線等から一定範囲     |\n| 耐火建築物             | 法2条九号の二             | 主要構造部等に耐火性能を確保した建築物   |\n| 準耐火建築物           | 法2条九号の三             | 主要構造部等に準耐火性能を確保した建築物 |\n| 防火設備               | 令109条等                 | 火炎の遮断等を目的とする設備             |\n| 特定防火設備           | 令112条等                 | 防火区画等で用いる高い遮炎性能の防火設備 |\n| 耐火性能               | 法2条七号・令107条        | 非損傷性・遮熱性・遮炎性                 |\n| 準耐火性能             | 法2条七号の二・令107条の2 | 準耐火建築物に要求される性能             |\n| 防火性能               | 法2条八号・令108条        | 外壁等に関する性能                       |\n| 準防火性能             | 法23条・令109条の9等      | 外壁等について要求される性能             |\n| 不燃材料               | 法2条九号・令108条の2     | 材料としての不燃性能                     |\n| 準不燃材料             | 令1条五号                 | 不燃材料に準ずる材料                     |\n| 難燃材料               | 令1条六号                 | 準不燃材料に準ずる材料                   |\n| 遮炎性能               | 法2条九号の二等           | 火炎を遮る性能                           |\n\n**【暗記BOX】材料と性能を混同しない**\n\n> **●**\n> 耐火・準耐火・防火・準防火＝建築物・部分に要求される「性能」の話。\n>\n> **●** 不燃・準不燃・難燃＝主として「材料」の話。\n>\n> **●**\n> 試験では「耐火構造」「準耐火構造」「防火構造」「不燃材料」を同じ階層だと思わせる選択肢に注意。\n\n## 1-4　耐火・準耐火性能の技術基準（暗記用）\n\n原教材の表はそのまま残しつつ、まず「何を比較している表か」を理解する。\n\n| **性能**       | **対象**                         | **見るポイント**                     |\n|----------------|----------------------------------|--------------------------------------|\n| 耐火性能       | 壁・床・柱・はり・屋根・階段等   | 非損傷性／遮熱性／遮炎性、時間で判定 |\n| 準耐火性能     | 壁・床・柱・はり・屋根・階段等   | 耐火性能より要求時間・範囲が異なる   |\n| 屋根の技術基準 | 防火・準防火地域等で追加規定あり | 一般の耐火・準耐火性能とは別に覚える |",
    name: "1-1 用語の定義",
    page: 11,
    topics: ["用語の定義"]
  }, {
    id: "h_1_2",
    textbook: "# 2　面積・高さ・階数の算定\n\n## 2-1　敷地面積に算入しないもの\n\n| **項目**                   | **原則**                        | **条文**     |\n|----------------------------|---------------------------------|--------------|\n| 道路境界線と道との間の部分 | 法42条2項道路のセットバック部分 | 令2条1項一号 |\n| 計画道路の敷地内部分       | 一定の場合に算入しない          | 法52条10項等 |\n| 壁面線による部分           | 一定の場合に算入しない          | 法52条11項等 |\n| 予定道路の敷地内部部分     | 一定の場合に算入しない          | 法68条の9等  |\n\n## 2-2　建築面積に算入しないもの\n\n| **項目**                       | **暗記内容**                                 | **根拠**     |\n|--------------------------------|----------------------------------------------|--------------|\n| 地階                           | 地盤面上1m以下の部分                         | 令2条1項二号 |\n| 高い開放性を有する建築物の部分 | 大臣指定構造等を有し、端から1m以内の部分     | 令2条1項二号 |\n| ひさし等                       | 外壁中心線から1m以上突出した部分等、一定部分 | 令2条1項二号 |\n\n**【暗記BOX】建築面積の超頻出**\n\n> **●** 「地階」＝地盤面上1m以下の部分は建築面積に算入しない。\n>\n> **●**\n> 「高い開放性」＝全部が無条件で不算入ではない。大臣が指定する構造等＋端から1m以内など条件を確認。\n>\n> **●** ひさしは「全部不算入」ではない。外壁中心線からの距離がポイント。\n\n## 2-3　延べ面積の算定\n\n原教材の「容積率算定上の不算入」は、実務上も試験上も非常に重要。\n\n| **対象**             | **算入限度・扱い**                | **暗記**      |\n|----------------------|-----------------------------------|---------------|\n| 自動車車庫等         | 延べ面積の1/5を限度として不算入   | 1/5           |\n| 備蓄倉庫等           | 延べ面積の1/50を限度として不算入  | 1/50          |\n| 自家発電設備等       | 延べ面積の1/100を限度として不算入 | 1/100         |\n| 宅配ボックス         | 延べ面積の1/100を限度として不算入 | 1/100         |\n| 住宅の地階           | 住宅部分の床面積の1/3を限度       | 1/3           |\n| エレベーター昇降路等 | 一定の場合に不算入                | 令135条の16等 |\n\n**覚え方：**「車は5、倉庫は50、発電・宅配は100」。\n\n## 2-4　高さ\n\n| **項目**     | **基本**                                               | **試験での注意**                     |\n|--------------|--------------------------------------------------------|--------------------------------------|\n| 起算点       | 原則：地盤面                                           | 道路高さ・斜線等では別の基準点が出る |\n| 地盤面       | 建築物が周囲の地面と接する位置の平均の高さ             | 高低差3m超では3m以内ごとに平均       |\n| 日影規制     | 法別表第四の平均地盤面                                 | 斜線制限の地盤面とは区別             |\n| 敷地に高低差 | 隣地・北側・道路等の基準高さに一定の算定方法あり       | 「高低差−1m」の1/2が頻出             |\n| 屋上部分     | 階段室・昇降機塔等の一定部分は高さに算入しない場合あり | 面積要件＋高さ12m等をセットで暗記    |\n\n## 2-5　階数\n\n| **ルール**         | **内容**                                                |\n|--------------------|---------------------------------------------------------|\n| 部分で階数が異なる | 原則として最大の階数                                    |\n| 屋上部分           | 昇降機塔・装飾塔等で建築面積の1/8以下は階数に算入しない |\n| 地階               | 倉庫・機械室等で建築面積の1/8以下は階数に算入しない     |\n\n**【暗記BOX】面積・高さ・階数の整理**\n\n> **●** 建築面積＝建物を上から見た面積のイメージ。\n>\n> **●** 延べ面積＝各階の床面積の合計。容積率算定では特例不算入がある。\n>\n> **●**\n> 高さ＝どこから測るかが重要。地盤面・道路中心・北側等を混同しない。\n>\n> **●** 階数＝最大階数が基本。ただし1/8ルール等の除外を覚える。",
    name: "1-2 面積・高さ・階数",
    page: 24,
    topics: ["面積", "高さ", "階数"]
  }, {
    id: "h_1_3",
    textbook: "# 3　建築確認（2025年4月改正を反映）\n\n**⚠️\n原教材から最も更新が必要な部分**　2025年4月1日施行の改正で、いわゆる「4号特例」の対象が縮小。現在は旧教材の「1号・2号・3号・4号」の表をそのまま暗記しない。\n\n| **現行区分** | **対象のイメージ**                                                                          | **確認・審査**                              |\n|--------------|---------------------------------------------------------------------------------------------|---------------------------------------------|\n| 新1号        | 法6条1項一号：別表第一（い）欄の用途に供する特殊建築物で、その用途部分の床面積合計が200㎡超 | 建築確認が必要                              |\n| 新2号        | 新1号を除き、階数2以上 又は 延べ面積200㎡超                                                 | 建築確認が必要。大規模修繕・模様替も対象    |\n| 新3号        | 新1・新2を除き、都市計画区域等内の建築物                                                    | 平屋かつ延べ200㎡以下など、審査省略対象あり |\n\n**重要：**「新2号＝木造だけ」ではない。現行法では構造によらず、階数2以上又は延べ面積200㎡超の建築物が基本的な区分となる。\n\n**【暗記BOX】2025年改正の数字**\n\n> **●** 200㎡＝新2号／新3号を分ける重要な数字。\n>\n> **●** 2階以上＝新2号の重要な条件。\n>\n> **●** 平屋かつ200㎡以下＝審査省略の基本ライン。\n>\n> **●**\n> 2025年4月以降の新築等では、原則として省エネ基準適合義務化も開始。\n\n## 3-1　確認申請が必要かを解く順番\n\n**1.** ① 用途を見る：特殊建築物か？ → 法6条1項一号の対象か？\n\n**2.** ② 階数を見る：2階以上か？\n\n**3.** ③ 延べ面積を見る：200㎡超か？\n\n**4.** ④ 区域を見る：都市計画区域等内か？\n\n**5.** ⑤ 工事種別を見る：新築・増築・改築・移転か？\n大規模修繕・模様替か？\n\n**6.** ⑥\n例外・緩和を見る：10㎡以内の増築等、防火・準防火地域との関係、審査省略等\n\n## 3-2　旧4号→現行制度の読み替え\n\n| **旧教材**                   | **現在の理解**                                                    |\n|------------------------------|-------------------------------------------------------------------|\n| 旧4号建築物                  | 現行では旧4号という区分をそのまま使わない。主に新2号・新3号へ整理 |\n| 2階建て木造住宅              | 原則：新2号。審査省略の対象外                                     |\n| 平屋・延べ200㎡以下          | 新3号となり、一定の場合に審査省略対象                             |\n| 木造戸建の大規模修繕・模様替 | 新2号に該当するものは建築確認が必要                               |\n\n## 3-3　確認申請の特例・注意\n\n- 増築・改築・移転で、防火地域・準防火地域外の一定の10㎡以内の工事は確認申請不要となる場合がある。\n\n- ただし「10㎡なら必ず不要」ではない。防火・準防火地域との関係を必ず見る。\n\n- 確認申請と、建築基準法上の適合性そのものは別問題。確認不要＝法適合不要ではない。\n\n# 4　構造計算適合性判定・確認申請の流れ\n\n| **段階**           | **誰が／何を**                                   | **覚え方**             |\n|--------------------|--------------------------------------------------|------------------------|\n| 構造計算適合性判定 | 一定の構造計算について第三者機関等が判定         | 「構造計算のチェック」 |\n| 建築確認           | 建築主が申請、建築主事又は指定確認検査機関が審査 | 「建ててよいか」       |\n| 中間検査           | 特定工程終了後に受検                             | 「途中でチェック」     |\n| 完了検査           | 工事完了後に受検                                 | 「完成して適法か」     |\n| 検査済証           | 完了検査合格後に交付                             | 「使える状態の証明」   |\n\n**【暗記BOX】主体を混同しない**\n\n> **●** 建築主＝申請する側。\n>\n> **●** 建築主事＝行政側の確認・検査を担う者。\n>\n> **●** 指定確認検査機関＝民間等の指定機関。\n>\n> **●** 特定行政庁＝建築行政を行う自治体側の主体。\n>\n> **●** 構造計算適合性判定＝建築確認とは別のチェック。\n\n# 5　中間検査・完了検査・使用制限\n\n## 5-1　中間検査\n\n- 特定工程に係る工事を終えたときは、中間検査を受ける必要がある場合がある。\n\n- 特定工程は、建築物の用途・規模・構造等に応じて政令・特定行政庁が定める。\n\n- 共同住宅で階数3以上の場合など、頻出の特定工程がある。\n\n**試験の視点：**「工事完了後の完了検査」と「特定工程終了後の中間検査」を区別する。\n\n## 5-2　完了検査前の使用制限\n\n- 原則として、完了検査を受けるべき建築物等は、検査済証の交付を受けるまで使用できない場合がある。\n\n- 仮使用認定などの制度があるため、「絶対に使用不可」と丸暗記しない。\n\n- 誰が認定するか、どの建築物が対象かを問題文で確認する。\n\n# 6　工事届・建築物除却届\n\n| **手続き**   | **提出者** | **提出先**   | **ポイント**         |\n|--------------|------------|--------------|----------------------|\n| 建築工事届   | 建築主     | 都道府県知事 | 確認申請とは別手続き |\n| 建築物除却届 | 工事施工者 | 都道府県知事 | 除却時の届出         |\n\n*原教材の「床面積10㎡以内の除外」は、工事届・除却届のそれぞれの制度上の条件を条文で確認する。*\n\n# 7　定期報告\n\n**定期報告（法12条）**＝一定の建築物・建築設備等について、所有者等が定期的に調査・検査し、特定行政庁へ報告する制度。\n\n| **覚えるもの** | **内容**                                         |\n|----------------|--------------------------------------------------|\n| 対象           | 一定の特殊建築物等、建築設備、防火設備、昇降機等 |\n| 誰が           | 所有者・管理者等（制度ごとに確認）               |\n| 誰に           | 特定行政庁                                       |\n| 何を           | 建築物の状況、設備の作動等を調査・検査し報告     |\n| 目的           | 老朽化・避難設備不備・設備不良等による事故を防止 |\n\n**【暗記BOX】定期報告のひっかけ**\n\n> **●** 「確認申請が必要な建築物」＝「必ず定期報告対象」ではない。\n>\n> **●**\n> 定期報告の対象・規模・報告時期は法12条、政令、特定行政庁の指定を確認する。\n>\n> **●** 特定行政庁の指定によって対象範囲が変わる部分がある。\n\n# 8　この章で絶対に覚える数字\n\n| **数字** | **意味**                                                 | **記憶フレーズ**    |\n|----------|----------------------------------------------------------|---------------------|\n| 200㎡    | 新2号／新3号の重要ライン、特殊建築物の確認対象等にも登場 | 「200が総則の境界」 |\n| 2階      | 新2号の重要条件                                          | 「2階以上は新2号」  |\n| 10㎡     | 防火・準防火地域外の一定の増築等の確認申請除外           | 「10㎡は区域確認」  |\n| 1/5      | 車庫等の容積率不算入限度                                 | 「車5分の1」        |\n| 1/50     | 備蓄倉庫等                                               | 「倉庫50分の1」     |\n| 1/100    | 自家発電設備・宅配ボックス等                             | 「設備100分の1」    |\n| 1/3      | 住宅地階の容積率不算入限度                               | 「住宅地下3分の1」  |\n| 1/8      | 屋上・地階部分の階数算定等                               | 「階数8分の1」      |\n| 3m       | 高低差が3mを超える場合の地盤面算定                       | 「3m超で分割平均」  |\n| 12m      | 一定の屋上部分を高さに算入しない規定で登場               | 「屋上12m」         |\n\n# 9　過去問を解くための「判定フロー」\n\n**問題文を読んだら、頭の中でこの順番に仕分ける。**\n\n- 用途 → 特殊建築物？ 別表第一？\n\n- 規模 → 床面積200㎡？ 500㎡？ 1,000㎡？\n\n- 階数 → 平屋？ 2階？ 3階以上？\n\n- 構造 → 木造？ 耐火？ 準耐火？\n\n- 区域 → 防火地域？ 準防火地域？ 都市計画区域？\n\n- 手続 → 確認？ 中間検査？ 完了検査？ 定期報告？\n\n- 最後に「例外」を探す\n\n# 10　原教材からの更新ポイント（2025年4月以降）\n\n| **旧教材で見かける表現**     | **現在の勉強での扱い**                                       |\n|------------------------------|--------------------------------------------------------------|\n| 4号建築物                    | 歴史的な制度として理解。現行試験では新2号・新3号を中心に整理 |\n| 2階建て木造住宅は4号         | 誤解しやすい。現在は原則「新2号」で審査省略なし              |\n| 4号特例                      | 現在は審査省略制度の対象が「平屋かつ200㎡以下」へ縮小        |\n| 木造戸建の確認不要という感覚 | 現在は200㎡超・2階以上などで確認が必要                       |\n| 省エネ基準                   | 2025年4月から原則すべての新築で適合義務化                    |\n\n**※注意：**過去問は「当時の法令」を前提に出題されているため、過去問の正誤判断では出題年度の法令と現行法を区別する。\n\n# 11　参考法令・公式資料\n\n- 建築基準法 第2条（用語の定義）\n\n- 建築基準法 第6条・第6条の4（建築確認・審査省略）\n\n- 建築基準法 第7条・第7条の3・第7条の6（完了検査・中間検査・使用制限）\n\n- 建築基準法 第12条（定期報告）\n\n- 建築基準法 第15条（工事届等）\n\n- 建築基準法施行令 第1条・第2条（用語・面積等の算定）\n\n- 建築基準法施行令\n  第107条・第107条の2・第108条等（耐火・準耐火・防火関係）\n\n- 国土交通省「建築確認・検査の対象となる建築物の規模等の見直し」\n\n- 国土交通省「2025年4月からの建築基準法・建築物省エネ法改正」\n\n**更新基準：2026年8月時点。**\n本資料は試験勉強用の整理資料であり、個別案件の法適合判断では法令本文・告示・所管行政庁の取扱いを確認する。",
    name: "1-3 手続き",
    page: 35,
