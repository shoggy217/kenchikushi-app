...
// ── HOME TAB ───────────────────────────────────────────────
function HomeTab(_ref3) {
  let streak = _ref3.streak,
    todayMin = _ref3.todayMin,
    totalStudyMin = _ref3.totalStudyMin,
    weakQuestions = _ref3.weakQuestions,
  ...
  }, [["#34D399", stats.mastered], ["#FBBF24", stats.learning], ["#F87171", stats.weak], ["rgba(255,255,255,0.1)", stats.untried]].map((_ref5, i) => {
  ...
  }, [["#34D399", "習得済", stats.mastered], ["#FBBF24", "学習中", stats.learning], ["#F87171", "要復習", stats.weak], ["rgba(255,255,255,0.25)", "未着手", stats.untried]].map(_ref7 => {
...
// ── QUIZ TAB ───────────────────────────────────────────────
function QuizTab(_ref9) {
  let questions = _ref9.questions,
    setQuestions = _ref9.setQuestions,
    addXp = _ref9.addXp;
  ...
  if (!pool.length) return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(FilterBar, {
    questions: questions,
    subj: subj,
    mode: mode,
    reset: reset
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    mode: mode,
    reset: reset
  }), session.total > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 16,
      paddingLeft: 4,
  ...
  }, /*#__PURE__*/React.createElement("span", null, "\u89E3\u7B54 ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: "#fff"
    }
  }, session.total)), /*#__PURE__*/React.createElement("span", null, "\u6B63\u7B54\u7387 ", /*#__PURE__*/React.createElement("b", {
    style: {
      color: "#fff"
    }
  ...
  }, idx % pool.length + 1, "/", pool.length)), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between",
...
function FilterBar(_ref0) {
  ...
  }, [["AB", "A・B優先", null], ["A", "Aのみ", null], ["all", "全難易度", null], ["weak", "要復習", "#F87171"], ["starred", "★", "#FBBF24"], ["untried", "未着手", null]].map(_ref1 => {
...
// ── LOG TAB ────────────────────────────────────────────────
function LogTab(_ref11) {
  let logs = _ref11.logs,
    setLogs = _ref11.setLogs;
  ...
  const save_ = () => {
    const cleaned = {};
    Object.entries(inputs).forEach(_ref12 => {
  ...
  }, "\u4FDD\u5B58")), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(SectionTitle, null, "\u76F4\u8FD114\u65E5"), /*#__PURE__*/React.createElement(ResponsiveContainer, {
    width: "100%",
    height: 140
...
// ── AI TAB ─────────────────────────────────────────────────
function AITab(_ref14) {
  let questions = _ref14.questions,
    weakQuestions = _ref14.weakQuestions;
...
// ── MANAGE TAB ─────────────────────────────────────────────
function ManageTab(_ref15) {
  let questions = _ref15.questions,
    setQuestions = _ref15.setQuestions,
    pendingCount = _ref15.pendingCount,
    importPending = _ref15.importPending;
  ...
  }, "\u30C1\u30E3\u30C3\u30C8\u306B\u554F\u984C\u96C6\u306E\u5199\u771F\u3092\u9001\u308A", /*#__PURE__*/React.createElement("br", null), "\u300C\u554F\u984C\u3092\u767B\u9332\u3057\u3066\u300D\u3068\u8A00\u3046\u3060\u3051")), /*#__PURE__*/React.createElement(Card, null, /*#__PURE__*/React.createElement(SectionTitle, null, "\u4F7F\u3044\u65B9"), [["1", "問題集の写真をチャットに送る"], ["2", "「問題を登録して」と送る"], ["3", "このタブに通知が来る"], ["4", "ボタン1タップで完了"]].map(_ref16 => {
