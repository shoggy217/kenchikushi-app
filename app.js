...
const BUNDLED_QUESTIONS = [{
  ...
  textbook: `【工事請負契約約款（民間七会）主要条文】
1条: 設計図書＝設計図・仕様書・現場説明書・質問回答書（請負代金内訳書は含まない）
4条: 受注者は契約後速やかに請負代金内訳書・工程表を発注者に提出、内訳書は監理者の確認
5条: 一括下請負の禁止（共同住宅新築工事は承諾があっても不可、その他は書面承諾があれば可）
7条: 特許権等の使用は受注者が責任を負う（発注者・監理者が指定した場合を除く）
9条: 監理者は発注者の委託を受け技術的検討・回答等を行う
10条: 受注者は主任技術者又は監理技術者を置き、氏名を書面で発注者に通知
12条: 発注者は監理者の意見に基づき受注者の工事関係者の措置を求めることができる
13条: 工事材料の品質は設計図書に明示なき場合は中等の品質、不合格材料は受注者の責任で引取り
16条: 受注者は設計図書に表示不明・誤謬・脱漏を発見したら書面で発注者又は監理者に通知
17条: 監理者は不適合施工の疑いがある場合、理由を受注者に通知のうえ破壊検査できる（同意不要）
19条: 第三者損害は発注者負担（受注者の故意・過失は受注者負担）
23条: 受注者は工事完了後、発注者に検査を求める（立会いを監理者に委託した場合は監理者立会い）
24条: 部分使用の手続き費用は発注者負担
26条: 出来高部払い＝監理者検査合格の出来形部分等の9/10
27条の2: 建築設備機器・室内仕上げ・家具等の契約不適合は引渡し時に請求（一般的注意で発見不可なら1年）
29条: 追加・変更時の代金変更→増加部分は監理者確認の内訳書単価、減少部分は変更時時価

【建築設計・監理等業務委託契約約款（四会）主要条文】
2条: 協議で決定した事項は速やかに書面作成・記名押印
6条: 履行期間・業務内容変更時、委託者は受託者に監理業務方針の再説明を請求できる
12条: 受注者は監理者の処置が著しく不当な場合、書面で発注者に異議申立て可
14条: 委託者承諾のうえ業務の一部を第三者に委託した場合、当該第三者の行為全てについて責任を負う
15条: 受注者は本契約に定めがある場合又は委託者の請求があるときは業務進捗状況を説明・報告
16条の2: 設計変更業務は原設計者に別途委託（原設計者が受諾しない場合は第三者に委託可）
19条: 委託者の責めに帰さない事由で業務終了時、既遂行業務の割合に応じた報酬を請求可
22条: 委託者の債務不履行による損害賠償請求可`,
  textbook: `【工事請負契約約款（民間七会）主要条文】
1条: 設計図書＝設計図・仕様書・現場説明書・質問回答書（請負代金内訳書は含まない）
4条: 受注者は契約後速やかに請負代金内訳書・工程表を発注者に提出、内訳書は監理者の確認
5条: 一括下請負の禁止（共同住宅新築工事は承諾があっても不可、その他は書面承諾があれば可）
...
22条: 委託者の債務不履行による損害賠償請求可`,
  ...
  refs: "国土交通省告示", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  ...
  refs: "建築設計・監理等業務委託契約約款22条、工事請負契約約款16条・17条", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}, {
  id: "sekou_H29_04",
  ...
  refs: "建築設計・監理等業務委託契約約款16条の2", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}, {
  id: "sekou_H28_06",
  ...
  refs: "工事請負契約約款10条", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}, {
  id: "sekou_H27_07",
  ...
  refs: "工事請負契約約款17条", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}, {
  id: "sekou_H26_08",
  ...
  refs: "工事請負契約約款29条", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}, {
  id: "sekou_H25_09",
  ...
  refs: "工事請負契約約款5条", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}, {
  id: "sekou_H25_10",
  ...
  refs: "工事請負契約約款23条", textbook: `【工事請負契約約款主要条文】1条:設計図書=設計図・仕様書・現場説明書・質問回答書(内訳書含まず) 4条:内訳書・工程表提出→内訳書は監理者確認 5条:一括下請禁止(共住新築は承諾があっても不可) 7条:特許権等は受注者責任(発注者・監理者指定除く) 10条:主任技術者・監理技術者→氏名を発注者に通知 12条:発注者は監理者意見で工事関係者の措置を求めることができる 13条:材料品質明示なき場合は中等品質 16条:設計図書の不明・誤謬発見→書面で発注者又は監理者に通知 17条:不適合施工疑い→理由を通知のうえ破壊検査可(同意不要) 23条:工事完了→発注者に検査を求める(立会委託は監理者立会) 24条:部分使用手続費用は発注者負担 26条:部払い=9/10 27条の2:建築設備・仕上・家具等の不適合→引渡時請求(発見不可なら1年) 29条:追加・変更→増加は内訳書単価・減少は時価 【監理等業務委託契約約款】6条:変更時に再説明請求可 12条:監理者の不当処置→発注者に異議申立 14条:第三者委託は全責任 16条の2:設計変更は原設計者に委託(受諾なき場合は第三者可) 22条:委託者の債務不履行→損害賠償請求可`,
  starred: false, history: []
}];
const BUNDLE_VER = "v10";
